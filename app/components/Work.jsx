  ...
  return (
    <motion.div
      ...
      className='grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] my-10 gap-5 dark:text-black'>
        {workData.map((project, index) => (
          ...
          rounded-lg relative cursor-pointer group">
            ...
            -translate-x-1/2 px-5 py-3 flex items-center justify-between justify-between 
      ...
      py-3 px-10 mx-auto my-20 hover:bg-lighthover duration-500 dark:text-white dark:border-white dark:hover:bg-darkHover   '>
        Show more<Image src={isDarkMode ? assets.right_arrow_bold_dark : assets.right_arrow_bold} alt="ArrowIcon" className="w-4"/>
      </motion.a>
    </motion.div>
  )
}
